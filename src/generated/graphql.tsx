...
export type LunchesDataListQueryVariables = Exact<{ [key: string]: never; }>;


export type LunchesDataListQuery = { __typename?: 'Query', launches?: Maybe<Array<Maybe<{ __typename?: 'Launch', mission_id?: Maybe<Array<Maybe<string>>>, flight_number?: Maybe<number>, mission_name?: Maybe<string>, launch_year?: Maybe<number>, launch_success?: Maybe<boolean> }>>> };

export type LuncheInfoDataQueryVariables = Exact<{
  id: Scalars['String'];
}>;


export type LuncheInfoDataQuery = { __typename?: 'Query', launch?: Maybe<{ __typename?: 'Launch', mission_name?: Maybe<string>, flight_number?: Maybe<number>, launch_year?: Maybe<number>, launch_success?: Maybe<boolean>, details?: Maybe<string>, launch_site?: Maybe<{ __typename?: 'LaunchSite', site_name?: Maybe<string> }>, rocket?: Maybe<{ __typename?: 'LaunchRocket', rocket_name?: Maybe<string>, rocket_type?: Maybe<string> }> }> };


export const LunchesDataListDocument = gql`
...
/**
 * __useLunchesDataListQuery__
 *
 * To run a query within a React component, call `useLunchesDataListQuery` and pass it any options that fit your needs.
 * When your component renders, `useLunchesDataListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useLunchesDataListQuery(baseOptions?: Apollo.QueryHookOptions<LunchesDataListQuery, LunchesDataListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LunchesDataListQuery, LunchesDataListQueryVariables>(LunchesDataListDocument, options);
      }
export function useLunchesDataListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LunchesDataListQuery, LunchesDataListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LunchesDataListQuery, LunchesDataListQueryVariables>(LunchesDataListDocument, options);
        }
export type LunchesDataListQueryHookResult = ReturnType<typeof useLunchesDataListQuery>;
export type LunchesDataListLazyQueryHookResult = ReturnType<typeof useLunchesDataListLazyQuery>;
export type LunchesDataListQueryResult = Apollo.QueryResult<LunchesDataListQuery, LunchesDataListQueryVariables>;
export const LuncheInfoDataDocument = gql`
...
/**
 * __useLuncheInfoDataQuery__
 *
 * To run a query within a React component, call `useLuncheInfoDataQuery` and pass it any options that fit your needs.
 * When your component renders, `useLuncheInfoDataQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useLuncheInfoDataQuery(baseOptions: Apollo.QueryHookOptions<LuncheInfoDataQuery, LuncheInfoDataQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LuncheInfoDataQuery, LuncheInfoDataQueryVariables>(LuncheInfoDataDocument, options);
      }
export function useLuncheInfoDataLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LuncheInfoDataQuery, LuncheInfoDataQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LuncheInfoDataQuery, LuncheInfoDataQueryVariables>(LuncheInfoDataDocument, options);
        }
export type LuncheInfoDataQueryHookResult = ReturnType<typeof useLuncheInfoDataQuery>;
export type LuncheInfoDataLazyQueryHookResult = ReturnType<typeof useLuncheInfoDataLazyQuery>;
export type LuncheInfoDataQueryResult = Apollo.QueryResult<LuncheInfoDataQuery, LuncheInfoDataQueryVariables>;